...
//        }
    ...
    public static Hashtable<String,Doc> getAllDocs() throws SQLException {
        refreshDataFromDb();
        return docs;
    }
...
//			throw new SQLException( "Error in excecuting Query" );
    ...
    public static Hashtable<String, User> getAllUser() throws SQLException {
//		if ( !connectToDB )
//	        throw new SQLException( "Not Connected to Database" );
//
//		double ranValue=Math.random();
...
//        return e;
    ...
    public static Hashtable<String,User> updateUser(String name, String password, String role) throws SQLException {
        User user;
//		if ( !connectToDB )
//	        throw new SQLException( "Not Connected to Database" );
//
...
//			throw new SQLException( "Error in excecuting Update" );
    ...
    public static Hashtable<String,User> insertUser(String name, String password, String role) throws SQLException {
        User user;
...
//			throw new SQLException( "Error in excecuting Insert" );
    ...
    public static Hashtable<String,User> deleteUser(String name) throws SQLException {
//		if ( !connectToDB )
//	        throw new SQLException( "Not Connected to Database" );
//
//		double ranValue=Math.random();
