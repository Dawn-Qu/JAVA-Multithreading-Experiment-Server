...
public abstract class User implements Serializable {
	...
	private static final long serialVersionUID = 6105029613990173259L;
	private String name;
...
//	public abstract void choose(int choice);
	...
	public boolean changeSelfInfo(String password) throws SQLException {
		//写用户信息到存储
		if (DataProcessing.updateUser(name, password, role)!=null){
			this.password=password;
...
//		javapractice.DataProcessing.downloadFile(filename);
